...
public class Topchampions implements Serializable {
    ...
    public Topchampions(int championId, long summonerId) {
    ...
    @XmlTransient
    public List<Builds> getBuildsList() {
        return buildsList;
    }

    public void setBuildsList(List<Builds> buildsList) {
    ...
    public String toString() {
        return "models.Topchampions[ topchampionsPK=" + topchampionsPK + " ]";
    }
