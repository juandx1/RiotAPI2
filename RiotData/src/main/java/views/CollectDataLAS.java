...
public class CollectDataLAS {

    public static final String API_KEY = "api_key=33b1e8e7-58e3-4e15-a8bb-157f50a879a5";
    public static final String END_POINT = "https://las.api.pvp.net/";
                    ...
                    if (recentGamesDTO != null && recentGamesDTO.games != null) {
                        for (GameDTO gameDTO : recentGamesDTO.games) {
                            ...
                            for (GameDTO gameDTO1 : recentGamesDTO.games) {
                                for (PlayerDTO playerDTO : gameDTO1.fellowPlayers) {
