...
public class Builds extends GenericModel implements Serializable{
    ...
    public Builds(long matchId,int championId, int summonerId) {
        this.buildsPK = new BuildsPK(matchId, championId, summonerId);
    }
    ...
    public String toString() {
        return "riot.Builds[ buildsPK=" + buildsPK + " ]";
    }
